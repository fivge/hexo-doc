---
title: Android Unpack Rom
date: 2017-07-14 20:25:37
tags:
- Android
categories:
- Android
...
很久未研究过刷机包了,由于Android的新机制,现在绝大多数的ROM都不是直接`zip`就能解包的了,很多解压后在`./system`下都只有一个`build.prop`文件,而那些`app`,`priv-app`,`media`等文件都被放在一个叫`system.new.dat`的文件中

而这个文件又不能直接解压

![](https://ws2.sinaimg.cn/large/006tKfTcly1fhjouvt9n0j30hd08r0tn.jpg)

在xda论坛上发现这么一个python工具:
